...
This repo has a few different audiences, so the docs are organized by task instead of keeping everything in one long README.
...
| Lab | Location |
|---|---|
| Lab 06: Pick and place with Kinova Gen3 Lite | [lab06_files/README.md](../lab06_files/README.md) |
| Lab 07: 3D goal control and trajectory evaluation | [lab07_files/README.md](../lab07_files/README.md) |
...
1. Use [Setup scripts guide](setup_scripts.md) to choose the right bootstrap script.
2. Keep this page as the source of truth for documentation navigation.
3. When a guide grows beyond one workflow, split it again instead of expanding the top-level README.
