...
avoid; remove it and the path goes straight again. This is the single most important
skill for the challenge.
...
!!! tip "This is the challenge skill"
    The competition is built on exactly this: an obstacle between the blocks and the
    goal. Time spent here is time spent practicing for the stack-off.
