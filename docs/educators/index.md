...
<div class="toolkit-hero" style="background: linear-gradient(135deg, rgba(146, 64, 14, 0.92), rgba(180, 83, 9, 0.88));">
...
- **Overview**
    ...
    What this site contains, what transfers cleanly to other institutions, and what you should expect to replace. Start here if you're evaluating this material.

    [:octicons-arrow-right-24: Overview](../for-educators.md)
