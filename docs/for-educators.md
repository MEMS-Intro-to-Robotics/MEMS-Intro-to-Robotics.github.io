...
This site publishes the public-facing lab manuals, setup guides, and technical references for Duke's Introduction to Robotics and Automation course (ECE 383 / ME 555). It has two jobs:
...
This repository contains the public course material, but a few supporting assets are not yet mirrored here:
...
The written labs are still useful without those pieces, but outside instructors should account for the gaps before adopting the site wholesale.
